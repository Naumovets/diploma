...
def calculate_plane_info(centers, normals, rotations):
    ...
    for i, (center, normal) in enumerate(zip(centers, normals)):
        ...
        info_text += f"Плоскость {i+1}:\n  Расстояние до начала: {distance:.3f}\n"
...
def show_main_window():
    ...
    main_window.title("3D Визуализация и анализ движения")
    ...
    # Вкладка 1: 3D-визуализация
    tab1 = ttk.Frame(notebook)
    notebook.add(tab1, text="3D Визуализация")
    ...
    # Панель управления и информация
